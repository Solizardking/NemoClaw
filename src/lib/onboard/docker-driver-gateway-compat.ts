...
export function logContainerizedDockerDriverGatewayLaunch(
  ...
  warn(
    "  SECURITY NOTICE: compatibility container uses host networking plus Docker API access; enabled only by NEMOCLAW_OPENSHELL_GATEWAY_CONTAINER_PATCH=1. Review/removal conditions: docs/security/openshell-0.0.72-compatibility-review.md#source-of-truth-boundaries.",
  );
  log(
