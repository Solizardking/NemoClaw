...
Current NemoClaw releases fail closed in this state: recovery stops Hermes gateway/dashboard processes, prints `SECRET_BOUNDARY_VALIDATOR_MISSING`, and refuses to claim the secret boundary was checked.
