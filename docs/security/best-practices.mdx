...
| Recommendation | OpenShell 0.0.72 supports glibc 2.28 or newer. Prefer a directly supported host and use the compatibility container only as an explicit local bridge on an older trusted host. |
