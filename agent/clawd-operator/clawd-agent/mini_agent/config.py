...
class SolanaAgentConfig:
    ...
    def from_env(cls, env_path: Optional[str] = None) -> "SolanaAgentConfig":
        ...
        # Build configs - prefer DeepSeek native, fall back to OpenRouter
        deepseek_api_key = os.getenv("DEEPSEEK_API_KEY") or openrouter_api_key
        llm_config = LLMConfig(
            api_key=deepseek_api_key,
            api_base=os.getenv("DEEPSEEK_BASE_URL") or os.getenv("OPENROUTER_API_BASE", "https://api.deepseek.com"),
            model=os.getenv("DEEPSEEK_MODEL") or os.getenv("OPENROUTER_MODEL") or os.getenv("OPENROUTER_CLAUDE", "deepseek/deepseek-chat-v3.1"),
        )
    ...
    def from_yaml(cls, config_path: str | Path, env_path: Optional[str] = None) -> "SolanaAgentConfig":
        ...
        # LLM config - prefer DeepSeek native, fall back to OpenRouter
        llm_data = data.get("llm", {})
        llm_config = LLMConfig(
            api_key=llm_data.get("api_key") or os.getenv("DEEPSEEK_API_KEY") or os.getenv("OPENROUTER_API_KEY"),
            api_base=llm_data.get("api_base") or os.getenv("DEEPSEEK_BASE_URL") or os.getenv("OPENROUTER_API_BASE", "https://api.deepseek.com"),
            model=llm_data.get("model") or os.getenv("DEEPSEEK_MODEL") or os.getenv("OPENROUTER_MODEL") or os.getenv("OPENROUTER_CLAUDE", "deepseek/deepseek-chat-v3.1"),
