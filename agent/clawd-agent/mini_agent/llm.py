...
class LLMClient:
    ...
    def __init__(
        ...
        self._client = httpx.AsyncClient(
            ...
            headers={
                ...
                "HTTP-Referer": "https://github.com/clawd-bot",
                "X-Title": "CLAWD Solana Trading Agent",
            },
            timeout=timeout
        )
    ...
    def is_deepseek(self) -> bool:
        """Whether this client is targeting the DeepSeek OpenAI-compatible API."""
        return "api.deepseek.com" in self.api_base
