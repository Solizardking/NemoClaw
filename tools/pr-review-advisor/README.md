...
- Solana-related changed files are classified deterministically before model analysis so RPC, wallet, financial-harness, policy preset, Telegram bridge, payment/x402/Kora, and Solana E2E tooling changes are reviewed as high-risk surfaces even when the PR text downplays them.
