...
Orchestrates the Nemo Clawd sandbox lifecycle inside OpenShell.
...
def action_plan(
    ...
    *,
    ...
    plan: dict[str, Any] = {
        ...
        "profile": profile,
        "sandbox": {
            "image": sandbox_cfg.get("image", "nemoclawd:latest"),
...
def action_apply(
    ...
    sandbox_image: str = sandbox_cfg.get("image", "nemoclawd:latest")
