...
// It also linked Sandbox Hardening through the old deployment/ directory
// rather than the current manage-sandboxes/ route.
...
describe("best-practices.mdx security-layer consistency (#5088)", () => {
  it("links Sandbox Hardening via the current manage-sandboxes path", () => {
