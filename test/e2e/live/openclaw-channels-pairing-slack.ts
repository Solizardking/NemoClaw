...
const SANDBOX_NAME =
  process.env.NEMOCLAW_SLACK_PAIRING_SANDBOX_NAME ?? "e2e-openclaw-channels-pairing-slack";
...
export const OPENCLAW_SLACK_PAIRING_TIMEOUT_MS = 55 * 60_000;
...
export async function runOpenClawSlackPairing({
  artifacts,
  cleanup,
  host,
  sandbox,
  ...
  await artifacts.writeJson("slack-target.json", {
